# By manish.17, contest: ITMO Academy. Двоичный поиск - 1, problem: (C) Closest to the Right
...
class Result:
    def __init__(self, index, value):
        self.index = index + 1 if index is not None else 0
        self.value = value
...
bs = BinarySearch()
print("\n".join(str(bs.greater_than(k-1, a).index) for k in b))
